...
def table_maker(MF: float) -> None:
    ...
    tabulated_eos.to_csv(f'/home/gustavo/Quarks/neutron_stars_computer/equationsofstate/tabulated_eos/DM_EOS/f_dm_m{MF}_y0.csv',
